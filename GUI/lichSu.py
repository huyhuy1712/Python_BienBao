...
class HistoryScreen(BoxLayout, Screen):
    def __init__(self, screen_manager, **kwargs):
        ...
        # Bảng dữ liệu (chỉ 3 cột)
        self.outer_scroll_view = ScrollView(size_hint=(1, 0.8), do_scroll_x=True, do_scroll_y=True)
        self.history_table = GridLayout(cols=3, size_hint_x=None, size_hint_y=None, spacing=2, padding=[10, 10])
    ...
    def populate_table_from_db(self):
        try:
            ...
            headers = ["Ảnh", "Loại hoạt động", "Thời gian"]
