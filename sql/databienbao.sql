...
-- Dumping database structure for databienbao
CREATE DATABASE IF NOT EXISTS `databienbao` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `databienbao`;

-- Dumping structure for table databienbao.history
CREATE TABLE IF NOT EXISTS `history` (
  ...
  PRIMARY KEY (`id_user`,`id_sign`,`time`),
  KEY `id_sign` (`id_sign`),
  CONSTRAINT `history_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE,
  CONSTRAINT `history_ibfk_2` FOREIGN KEY (`id_sign`) REFERENCES `sign` (`id_sign`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table databienbao.history: ~0 rows (approximately)

-- Dumping structure for table databienbao.sign
...
-- Dumping data for table databienbao.sign: ~298 rows (approximately)
INSERT INTO `sign` (`id_sign`, `name`, `image`, `type`, `description`) VALUES
	...
	(9, 'Biển Cấm ô tô tải theo trọng lượng', 'bien-bao-cam-106b-1590225342-width220height220', 1, 'biển đường cấm trọng lượng của xe ô tô tải được tính theo tấn ghi trên biển đi vào.'),
	...
	(49, 'Kiểm Tra', 'bien-bao-cam-129-1590227360-width233height233.jpg', 1, 'Biển báo này giúp thông báo cho người điều khiển phương tiện tham gia giao thông biết nơi có đặt trạm kiểm tra, các loại phương tiện vận tải qua đó phải dừng lại để làm thủ tục kiểm tra, kiểm soát theo quy định.'),
	(50, ' Cấm dừng và đỗ xe', 'bien-bao-cam-130-1590227395-width233height233.jpg', 1, ' biển cấm có hiệu lực cấm tất cả các xe cơ giới đừng bộ dừng lại và đỗ lại ở đường nơi đặt biển.'),
	(51, 'Cấm đỗ xe', 'bien-bao-cam-131a-1590227429-width233height233.jpg', 1, 'Cấm các loại xe cơ giới đỗ ở đường nơi có đặt biển bất kể ngày nào.'),
	...
	(100, 'Biển số 215b', 'Screenshot-2022-01-10-113455.jpg', 2, '“Kè, vực sâu phía bên trái”, báo trước sắp tới những vị trí có kè chắn vực sâu, hoặc sông suối đi sát đường, cần đề phòng tình huống nguy hiểm rơi xuống vực sâu hoặc sông suối (thường có ở những chỗ ngoặt nguy hiểm).'),
	(101, 'Biển số 215c', 'Screenshot-2022-01-10-113425.jpg', 2, '“Kè, vực sâu phía bên phải”, báo trước sắp tới những vị trí có kè chắn vực sâu, hoặc sông suối đi sát đường, cần đề phòng tình huống nguy hiểm rơi xuống vực sâu hoặc sông suối (thường có ở những chỗ ngoặt nguy hiểm).'),
	...
	(103, 'Biển số 216b', 'Screenshot-2022-01-10-113347.jpg', 2, '“Đường ngầm có nguy cơ lũ quét”, báo trước những vị trí có đường ngầm (đường tràn), đoàn đường thường qua sông suối và khe cạn thường xuyên có lũ quét.'),
	...
	(107, 'Biển số 220', 'Screenshot-2022-01-13-114845.jpg', 2, '“Dốc lên nguy hiểm”, báo trước sắp tới đoạn đường lên dốc nguy hiểm.'),
	...
	(139, 'Biển báo số W.243 (c)', 'Screenshot-2022-01-13-120432.jpg', 2, '“Nơi đường sắt giao không vuông góc với đường bộ” để báo trước sắp đến vị trí giao cắt đường bộ với đường sắt cùng mức, không vuông góc và không có người gác, không có rào chắn Đặt cách ray gần nhất 150m.'),
	...
	(156, 'Biển số R.302a', 'r302_0308144935a.jpg', 3, 'Hướng phải đi vòng chướng ngại vật'),
	(157, 'Biển số R.302b', 'r302_0308144935b.jpg', 3, 'Hướng phải đi vòng chướng ngại vật'),
	(158, 'Biển số R.302c', 'r302_0308144935c.jpg', 3, 'Hướng phải đi vòng chướng ngại vật'),
	...
	(167, 'Biển số R.310a', 'r310_0308144936a.jpg', 3, 'Để báo cho các loại xe chở hàng nguy hiểm phải đi theo hướng quy định, đặt một trong những kiểu biển số R.310(a,b,c) “Hướng đi phải theo cho các xe chở hàng nguy hiểm “.'),
	(168, 'Biển số R.310b', 'r310_0308144936b.jpg', 3, 'Để báo cho các loại xe chở hàng nguy hiểm phải đi theo hướng quy định, đặt một trong những kiểu biển số R.310(a,b,c) “Hướng đi phải theo cho các xe chở hàng nguy hiểm “.'),
	(169, 'Biển số R.310c', 'r310_0308144936c.jpg', 3, 'Để báo cho các loại xe chở hàng nguy hiểm phải đi theo hướng quy định, đặt một trong những kiểu biển số R.310(a,b,c) “Hướng đi phải theo cho các xe chở hàng nguy hiểm “.'),
	(170, ' Biển số R.403a', 'r403_0308144936a.jpg', 3, 'Đường dành cho xe ô tô'),
	(171, ' Biển số R.403b', 'r403_0308144936b.jpg', 3, 'Đường dành cho xe ô tô, xe máy'),
	(172, ' Biển số R.403c', 'r403_0308144936c.jpg', 3, 'Đường dành cho xe buýt'),
	(173, ' Biển số R.403d', 'r403_0308144936d.jpg', 3, 'Đường dành cho xe ô tô con'),
	(174, ' Biển số R.403e', 'r403_0308144936e.jpg', 3, 'Đường dành cho xe máy'),
	(175, ' Biển số R.403f', 'r403_0308144936f.jpg', 3, 'Đường dành cho xe máy và xe đạp '),
	(176, 'Biển số R.404a', 'r404_0308144936a.jpg', 3, 'Hết đoạn đường dành cho xe ô tô'),
	(177, 'Biển số R.404b', 'r404_0308144936b.jpg', 3, 'Hết đoạn đường dành cho xe ô tô, xe máy'),
	(178, 'Biển số R.404c', 'r404_0308144936c.jpg', 3, 'Hết đoạn đường dành cho xe buýt'),
	(179, 'Biển số R.404d', 'r404_0308144936d.jpg', 3, 'Hết đoạn đường dành cho xe ô tô con'),
	(180, 'Biển số R.404e', 'r404_0308144936e.jpg', 3, 'Hết đoạn đường dành cho xe máy'),
	(181, 'Biển số R.404f', 'r404_0308144936f.jpg', 3, 'Hết đoạn đường dành cho xe máy và xe đạp'),
	(182, 'Biển số R.411', 'r411_0308144937.jpg', 3, 'Để báo hiệu cho người tham gia giao thông biết số lượng làn đường trên mặt đường và hướng đi trên mỗi làn đường theo vạch kẻ đường, đặt biển số R.411 “Hướng đi trên mỗi làn đường theo vạch kẻ đường”. Biển sử dụng phối hợp với vạch kẻ đường (loại vạch 9.3: vạch mũi tên chỉ hướng trên mặt đường).'),
	...
	(191, 'Biển số R.415', 'r415_0308144937.jpg', 3, '“Biển gộp làn đường theo phương tiện” và “Kết thúc làn đường theo phương tiện”'),
	...
	(194, 'Biển R.E,11a', 'ham_0308144935a.jpg', 3, 'Để chỉ dẫn đoạn đường qua hầm có áp dụng quy định giao thông riêng'),
	(195, 'Biển R.E,11b', 'ham_0308144935b.jpg', 3, 'Để chỉ dẫn hết đoạn đường qua hầm, các quy định giao thông riêng không còn áp dụng'),
	...
	(198, 'Biển số I.405a', '405_1708165258a.jpg', 4, 'để chỉ lối rẽ vào đường cụt'),
	(199, 'Biển số I.405b', '405_1708165258b.jpg', 4, 'để chỉ lối rẽ vào đường cụt'),
	(200, 'Biển số I.405c', '405_1708165258c.jpg', 4, 'để chỉ dẫn phía trước là đường cụt'),
	...
	(202, 'Biển số I.407a', '407_1708165259a.jpg', 4, 'chỉ cho phép các loại phương tiện giao thông đi theo chiều vào theo mũi tên chỉ, cấm quay đầu ngược lại (trừ các xe được quyền ưu tiên theo quy định).'),
	(203, 'Biển số I.407b', '407_1708165259b.jpg', 4, 'chỉ cho phép các loại phương tiện giao thông đi theo chiều vào theo mũi tên chỉ, cấm quay đầu ngược lại (trừ các xe được quyền ưu tiên theo quy định).'),
	(204, 'Biển số I.407c', '407_1708165259c.jpg', 4, 'chỉ cho phép các loại phương tiện giao thông đi theo chiều vào theo mũi tên chỉ, cấm quay đầu ngược lại (trừ các xe được quyền ưu tiên theo quy định).'),
	(205, 'Biển số I.408', '408_1708165259.jpg', 4, 'Biển này để chỉ dẫn những nơi được phép đỗ xe, những bãi đỗ xe, bến xe…'),
	(206, 'Biển số 408a', '408a_1708165259.jpg', 4, 'Nơi đỗ xe một phần trên hè phố'),
	...
	(212, 'Biển số I.423a', '423_1708165300a.jpg', 4, 'Để chỉ dẫn người đi bộ và người tham gia giao thông biết vị trí dành cho người đi bộ sang ngang'),
	(213, 'Biển số I.423b', '423_1708165300b.jpg', 4, 'Để chỉ dẫn người đi bộ và người tham gia giao thông biết vị trí dành cho người đi bộ sang ngang'),
	(214, 'Biển số I.424a', '424_1708165300a.jpg', 4, 'Để chỉ dẫn cho người đi bộ sử dụng cầu vượt qua đường'),
	(215, 'Biển số I.424b', '424_1708165300b.jpg', 4, 'Để chỉ dẫn cho người đi bộ sử dụng cầu vượt qua đường'),
	...
	(226, 'Biển số I.433b', 'Screenshot-2022-01-20-120923b.jpg', 4, 'Trên các tuyến đường đối ngoại và các tuyến đường có nhiều người nước ngoài đi lại, để chỉ dẫn sắp đến nơi có vị trí cắm trại'),
	(227, 'Biển số I.433c', 'Screenshot-2022-01-20-120923c.jpg', 4, 'Nơi dành cho nhà lưu động'),
	(228, 'Biển số I.433d', 'Screenshot-2022-01-20-120923d.jpg', 4, 'Nơi cắm trại và nhà lưu động'),
	(229, ' Biển số I.433e', 'Screenshot-2022-01-20-120947.jpg', 4, 'rên các tuyến đường đối ngoại và các tuyến đường có nhiều người nước ngoài đi lại, để chỉ dẫn sắp đến nơi có nhà trọ'),
	(230, ' Biển số I.434a', 'Screenshot-2022-01-15-113521.jpg', 4, 'Bến xe buýt'),
	(231, 'Biển số I.434b', 'Screenshot-2022-01-20-120858.jpg', 4, 'Bến xe tải'),
	...
	(234, 'Biển số I.437', '437_1708165300.jpg', 4, 'Đường cao tốc'),
	...
	(249, 'Biển số S.505b', 'Screenshot-2022-01-21-114219.jpg', 5, 'Biển số S.505b được đặt bên dưới biển báo số P.106a “Cấm xe ôtô tải” để chỉ các loại xe tải chịu hiệu lực của biển báo và tải trọng toàn bộ xe cho phép (bao gồm tải trọng bản thân xe và khối lượng chuyên chở cho phép) tương ứng với mỗi loại xe không phụ thuộc vào số lượng trục.'),
	(250, 'Biển số S.505c', 'Screenshot-2022-01-21-114237.jpg', 5, 'a) Biển số S.505c được đặt bên dưới biển báo số P.106a “Cấm ôtô xe tải” để chỉ các loại xe tải có tải trọng trục lớn nhất cho phép tương ứng với mỗi loại trục (trục đơn, trục kép, trục ba).\r\nb) Biển S.505c được đặt cùng với biển số S.505b bên dưới biển số P.106 và các xe qua cầu phải thỏa mãn điều kiện của cả hai biển (biển số S.505b và S.505c);'),
	(251, ' Biển số S.506a', 's506_2406151147a.jpg', 5, ' Biển số S.506a được đặt bên dưới biển chỉ dẫn số I.401 trên đường ưu tiên để chỉ dẫn cho người tham gia giao thông trên đường này biết hướng đường ưu tiên ở ngã tư.'),
	(252, ' Biển số S.506b', 's506_2406151147b.jpg', 5, 'Biển số S.506b được đặt bên dưới biển số W.208 và biển số R.122 trên đường không ưu tiên để chỉ dẫn cho người tham gia giao thông trên đường này biết hướng đường ưu tiên ở ngã tư.'),
	...
	(254, 'Biển chỉ dẫn số lượng làn và hướng đi cho từng làn', 'g11_2406151146.jpg', 5, 'Để thông báo cho lái xe số làn và hướng đi của từng làn xe, đặt biển số S.G,11a; S.G,11c; các biển này phải có số mũi tên bằng số lượng làn xe đi cùng hướng và phải chỉ dẫn số lượng làn xe của hướng đi sắp tới.'),
	(255, 'Biển chỉ dẫn làn đường không lưu thông ', 'Screenshot-2022-01-21-114056.jpg', 5, 'Để chỉ dẫn cho lái xe biết làn đường không lưu thông, đặt biển S.G,12a; S.G,12b.'),
	(256, 'Biển báo phụ “Ngoại lệ”', 'Screenshot-2022-01-21-114123.jpg', 5, 'Để chỉ các trường hợp mà biển cấm hoặc hạn chế được coi là không áp dụng đặc biệt cho một nhóm đối tượng tham gia giao thông nào đó, đặt biển S.H,6 và thể hiện nhóm đối tượng đó cùng với cụm từ “Except – Ngoại lệ”.');
	

-- Dumping structure for table databienbao.user
...
-- Dumping data for table databienbao.user: ~4 rows (approximately)
INSERT INTO `user` (`id_user`, `username`, `password`, `avatar`) VALUES
	(1, 'anhhuy', '123', 'hinh-bau-troi-dem-anime-mau-tim.jpg'),
	(2, 'hoainam', '123', 'hinhanh1.jpg'),
	(3, 'thanhtung', '123', 'hinhanh2.jpg'),
	(4, 'congvinh', '123', 'hinhanh3.jpg'),
